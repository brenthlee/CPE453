   ...
   #define LWPH
      ...
      typedef struct __attribute__ ((aligned(16))) __attribute__ ((packed)) registers {
         unsigned long rax; //register a extended
         unsigned long rbx; //register b extended
         unsigned long rcx; //register c extended
         unsigned long rdx; //register d extended
         unsigned long rsi; //register source index (source for data copies)
         unsigned long rdi; //register destination index (destination for data copies)
         unsigned long rbp; //register base pointer
         unsigned long rsp; //register stack pointer
         unsigned long r8;
         unsigned long r9;
         unsigned long r10;
         unsigned long r11;
